# ===================================================================
# MONKEY-PATCH TO FIX THE "time_major" ERROR on Keras model loading
# ===================================================================
import keras

# Get a reference to the original LSTM class's from_config method
from_config_original = keras.layers.LSTM.from_config

# Define a new, patched from_config method
@classmethod
def from_config_patched(cls, config):
	# Check if the problematic 'time_major' argument is in the config
	if 'time_major' in config:
		# If it is, print a message and remove it
		print(">> Monkey-patch: Removed 'time_major' from LSTM config")
		del config['time_major']

	# THIS IS THE FIX -> We only pass the config.
	# Python will automatically pass 'cls' to the original classmethod.
	return from_config_original(config)

# Overwrite the LSTM class's method with our patched version
keras.layers.LSTM.from_config = from_config_patched
# ===================================================================
# END OF PATCH
# ===================================================================
